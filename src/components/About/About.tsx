...
const About = () => {
  ...
  return (
    <div className="flex flex-col gap-16 mx-auto w-4/5 pt-10 pb-10">
      <section
        id="tag-lines"
        className="bg-[#D7DFA3] hover:scale-105 duration-300 shadow-md shadow-[white]  p-10 text-white border-2"
      >
      ...
      <section
        id="mission"
        className="bg-[#D7DFA3] hover:scale-105 duration-300 shadow-md shadow-[white]  p-10 border-2"
      >
      ...
      <section
        id="location"
        className="bg-[#D7DFA3] shadow-md shadow-[white] hover:scale-105 duration-300  border-2 p-10"
      >
        <h1 className="text-center text-white text-4xl font-bold border-4 py-3 border-b-0 border-l-4 rounded-lg border-t-4 border-r-4 border-[#1A4862]">
          Our Shop Location
        </h1>
