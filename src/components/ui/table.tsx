...
>(({ className, ...props }, ref) => (
  <div className="relative lg:w-full overflow-auto">
    <table
      ref={ref}
      className={cn("lg:w-full caption-bottom text-sm", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 lg:px-2 text-left align-middle font-medium text-neutral-500 [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] dark:text-neutral-400",
      className
    )}
    {...props}
  />
